...
//Realizamos peticiones GET POST DELETE PUT
  ...
  module.exports = {
        ...
        postVenta(req, res){
              ...
              pool.query("INSERT INTO venta(id_cliente,id_producto,fecha,cantidad,precio) VALUES($1,$2,$3,$4,$5)",[req.body.cliente.id_cliente,req.body.producto.id_producto,req.body.fecha,
